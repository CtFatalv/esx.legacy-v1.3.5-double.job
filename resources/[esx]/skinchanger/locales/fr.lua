Locales['fr'] = {
  ...
  ['cheeks_3'] = 'joues 3',
  ['lip_fullness'] = 'lèvres',
  ['jaw_bone_width'] = 'mâchoire largeur',
  ['jaw_bone_length'] = 'mâchoire longueur',
  ['chin_height'] = 'menton hauteur',
  ['chin_length'] = 'menton longueur',
  ['chin_width'] = 'menton largeur',
  ['chin_hole'] = 'menton trou',
  ...
  ['eyebrow_depth'] = 'largeur des sourcils',
  ...
  ['chest_color'] = 'coleur pillositée',
  ['bodyb'] = 'imperfections du corps',
  ['bodyb_size'] = 'opacité imperfections',
  ['bodyb_extra'] = 'boutons sur le corps',
  ['bodyb_extra_thickness'] = 'opacité des boutons du corps',
}
