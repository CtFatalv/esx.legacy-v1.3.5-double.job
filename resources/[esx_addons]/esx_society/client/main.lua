...
RegisterNetEvent('esxnecro:setJob')
AddEventHandler('esxnecro:setJob', function(job)
...
RegisterNetEvent('esxnecro:setJob2')
AddEventHandler('esxnecro:setJob2', function(job2)
